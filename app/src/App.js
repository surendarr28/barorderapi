...
class App extends Component {
  ...
  componentDidMount = () => {
    ...
    window.addEventListener("mousemove", (e) => {
      ...
      if (deg > 80) {
        // document.getElementById("box1").style.bottom = "-1000px";
        // document.getElementById("box2").style.bottom = "-1000px";
        // document.getElementById("box3").style.bottom = "-1000px";
        // document.getElementById("box4").style.bottom = "-1000px";
        // document.getElementById("box5").style.bottom = "-1000px";
        // doll.style.top = "90%";
      }
      if (deg > 90) {
        // document.getElementById("box1").style.bottom = "-1000px";
